...
function preference(){
    swal({  title: 'Travel Preference',
        html:''+
        '<div class="container-fluid sweetalert"><div class="row"><div class="col-md-6"> <label>No.of passanger : </label></div><div class="col-md-6"><input type=number value="1" class="text-field"></div></div> ' +
        ...
        '<input type=number value="'+carbon_emission+'" class="text-field" id="carbon_emission"><br></div></div></div>'
...
function info(){
    swal({   title: 'Southwest Finland Routing',
        ...
        '<div class="sweetalert"><br><img src=images/car80.svg style="width: 30px; height:30px;"> '+
        ...
        '<img src=images/cip.png style="width: 60px; height:40px;"></div>'
