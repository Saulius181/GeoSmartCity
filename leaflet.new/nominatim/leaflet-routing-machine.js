...
(function() {
	...
	L.Routing.Itinerary = L.Control.extend({
		...
		_createAlternative: function(alt, i) {
			var altDiv = L.DomUtil.create('div', 'route-desktop bike' +
			...
			// partial implementation of the step generator for the new layout
			var altDivTable = L.DomUtil.create('table');
			altDivTable.innerHTML = '<th colspan="5">Distance:' + data.distance + ', Duration: '+ data.time + ', CO<sub>2</sub> Emission: 0.45g [<i class="fa fa-tree" aria-hidden="true"></i><i class="fa fa-tree" aria-hidden="true"></i>]</th>';
			
			for (var j = 0; j < data.instructions.length; j++){
				altDivTable.innerHTML += '<td>14:35 <i class="fa fa-map-marker" aria-hidden="true"></i><br><i class="fa fa-bicycle" aria-hidden="true"></i><sup> | Hamenkatu</sup></td><td>--------<sup>4.2 km</sup> <i class="fa fa-bicycle" aria-hidden="true"></i>------</td><td>14:35 <i class="fa fa-home" aria-hidden="true"></i><br><i class="fa fa-bicycle" aria-hidden="true"></i><sup> | Hamenkatu</sup></td>';
				
				
			}
			
			//altDiv.innerHTML = '<tr><td>14:35 <i class="fa fa-map-marker" aria-hidden="true"></i><br><i class="fa fa-bicycle" aria-hidden="true"></i><sup> | Hamenkatu</sup></td><td>--------<sup>4.2 km</sup><i class="fa fa-bicycle" aria-hidden="true"></i>------</td><td>14:35 <i class="fa fa-home" aria-hidden="true"></i><br><i class="fa fa-bicycle" aria-hidden="true"></i><sup> | Hamenkatu</sup></td></tr><tr><td>14:35 <i class="fa fa-map-marker" aria-hidden="true"></i><br><i class="fa fa-bicycle" aria-hidden="true"></i><sup> | Hamenkatu</sup></td><td>--------<sup>4.2 km</sup> <i class="fa fa-bicycle" aria-hidden="true"></i>------</td><td>14:35 <i class="fa fa-home" aria-hidden="true"></i><br><i class="fa fa-bicycle" aria-hidden="true"></i><sup> | Hamenkatu</sup></td></tr>';
			altDiv.appendChild(altDivTable);
	...
	L.Routing.OSRM = L.Class.extend({
		...
		buildRouteUrl: function(waypoints, options) {
			...
			if (document.getElementById("timeId").value){
				var timestring = document.getElementById("timeId").value;
			}
			else {
				var t = new Date();
				var timestring = t.toLocaleTimeString().replace(/([\t]+:[\t]{2})(:[\t]{2})(.*)/, "$1$3");
			}
